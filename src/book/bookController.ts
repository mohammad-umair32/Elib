...
const createBook = async (req: Request, res: Response, next: NextFunction) => {
  ...
  try {
    ...
    try {
      ...
      console.log("Error while delete temp file", error);
    }
...
const deleteBook = async (req: Request, res: Response, next: NextFunction) => {
  ...
  //book-covers/tyhvpzxa36jtzs34u4jy
  //book-pdfs/jjkzx4dcsfdx7jimnhth.pdf
  //https://res.cloudinary.com/dkozn02we/image/upload/v1753960301/book-covers/tyhvpzxa36jtzs34u4jy.png
